...
ALTER TABLE `computers` ADD `tableLocationID` INT( 10 ) UNSIGNED NOT NULL AFTER `computer_name`;
...
ALTER TABLE `computers` ADD `tableNameID` INT( 10 ) UNSIGNED NOT NULL AFTER `computer_name`;
